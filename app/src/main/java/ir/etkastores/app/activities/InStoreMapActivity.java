...
@Obfuscate
public class InStoreMapActivity extends BaseActivity implements EtkaToolbar.EtkaToolbarActionsListener {

    private final static String STORE_MODEL = "STORE_MODEL";

    public static void show(Context context, StoreModel storeModel) {
        Intent intent = new Intent(context, InStoreMapActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_store_map);
    ...
    private void initViews() {
        ...
        webView.loadUrl(ApiStatics.getInStoreMapUrl(storeModel.getCode()));
    }
    ...
    public void onOpenInInBrowserClick() {
        IntentHelper.showWeb(this, ApiStatics.getInStoreMapUrl(storeModel.getCode()));
    }
